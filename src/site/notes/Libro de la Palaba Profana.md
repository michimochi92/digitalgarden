...
### _Entrada recuperada del Cuaderno de Piel Gris, página 27_
⟟ᛟ ⋏⟟ ⟒ϟ†ᚢᚡ⟒ ρ⟟⟒ϟ⟒⋏†⟒ ⟒⋏ ᛘᛟᛘ⟒⋏†ᛟ ⟒xᚨᚲ†ᛟ ⋏ ϙᚢᚨ⋏Ðᛟ ⟒Ꝛ ᛘᚨ⟒ϟ†Ꝛᛟ Ð⟒ϲ⟟Ð⟟ᛟ ϲꝚᚢϲᚨꝚ ᛟꝚ ᚢᛘϐꝚᚨᛚ, ρ⟒Ꝛ⟟ ʃ’⟒ ⟒ϟϲᚢϲᚨÐᛟ ϟᚢϝ⟟ϲ⟟⟒⋏†⟒, ʃ’⟒ ϝ⟟ϟ†ᛟ ϟᚢϝ⟟ϲ⟟⟒⋏†⟒, ϲꝟ⋏ᚨ ρᚨꝚᚨ ϲꝟ⋏ρꝚ⟒⋏Ð⟒ᚱ qᚢ⟒ ᚨϙᚢ⟒⟱ ôᛚ⟒ϙᚢ⟱ ⋏ ϝᚢ⟒ fᚨ ᚢ⋏ ᚨϲϲ⟟Ð⟒⋏†⟒… ϟ⟟⋏ᛟ ᚨ ᚱ⟒⟟⟲ᚨᚡᚨϚ⟒⟟⟱ †ꝟꚱϟꟲÐᛟ.

ClᚨᚢÐꝚ⟟ᚲ ϟ⟟ᛟᛘρ⟒ hᚨϐᛚᚨᚢᚨ Ð⟒ ⟒ᛚᚨ v⟟Ðᚨ ϲᛟᛘᛘᛟ ϟ⟟ fᚢ⟒ϟ⟒ ᚢ⋏ h⟟ᛚᛟ Ð⟒ ôꝚᛟ qᚢ⟒ †ꝟÐᛟϟ ᚢ⟒ᛚᚨᚡᚨᛘϟ Ꝛᛟϟ⟟Ðᛟ ϐᚨjᛟ ⟒ᛚᚨ ρ⟟⟒ᛚ.  
ϙᚢᛟ⋏Ðᛟ plᚢϟ ϟᚨ⋏ᚨᚡᚨ ᚨ ⟒ᛚᚨ Ϸ⟒⋏†ᛟ, plᚢϟ cꝟ⋏ρ⟒⋏Ð⟒ἑ ᚨϙᚢ⟒⟨ᛚ⟩ h⟟ᛚᛟ, ê Ê cônf⟟Ꝛᛘ⟒ plᚢϟ ⟒ᛚ cꝟ⋏ρ⟒⋏Ð⟒ἑ, plᚢϟ †⟒ᛘ⟟ᚨ p⟒ꝚÐ⟒⟱.  
ϟᚢ ᚢ⋏⟟c⟟ϙᛟ †⟒ꝚꝚϟ — ê⟒ ᚢ⋏⟟c⟟ϙᛟ qᚢ⟒ jᚨᛘᚨϟ cꝟ⋏f⟒ϟϟ៲ ⟒⋏ ρᚢϐ⟚⟟ϲ — ᛟ ᚨ ᛘᛟꚱ⟟Ꝛ ᚨ⋏†ᛟϟ Ð⟒ ϟ⟒⟱Ꝛ⟒ ᚨ †ꝟÐᛟϟ qᚢ⟒ ᛚᛟ ⋏⟒ϲ⟟ϟ⟟†ᚨᚢᚨ⋏.

Lᛟ ϝ⟟ ϲϟ⟒ϐꝚᚨ⟱ϟ៲ ᚢ⋏⟨ᚨ⟩ ᚾᚢ⟟†, ÐϟϐᛚᚨÐᛟ ϟ⟟ ᛘ⟟ϟᛘ⟟ϟᛘᛟ, cô⋏ ᚲᚨϟ ᛘᚨ⋏Ôϟ †⟒ᛘϐᛚᚨ⋏Ðᛟϟ cô⋏ᛘᛟ ϟ⟟ cᚨ⟲ᚷᚨ⟚⟒ ϝ⟒ϲᛟ Ð⟒ †ꝟÐᚨϟ ⟒Ϻρᛚ⟒ᚷᚨ⟱ᚨϟ qᚢ⟒ ⋏ᚢ⋏ᚲ៲ ᛚ⟟ɡᛟ⟲ᚨ⟚⟟ᚨ†⟟⟒⋏Ð⟟ᚨ.  
⟒h⟟ ê⋏†⟒⋏Ð⟟ qᚢ⟒ ϟᚢ ϐꝟ⋏ÐᚨÐ nᛟ êrᚨ ⟟⋏f⟟⋏⟟†ᚨ: êrᚨ ᚢ⋏ᚨ hᛟɡᚢ⟨ᚱ⟩ᚨ, ⟟ᛘ⟟⟮ᛟ⟮sᚨ ê ϲᚨꚱÐ⟟ᚨ, p⟒Ꝛᛟ cᛟ⋏Ð⟒⋏ᚨÐᚨ ᚨ cᛟ⋲sᚢᛘ⟟⟒Ꝛs⟒.

Ê†ô⋏ϟᛟ⋏ϟᚨ, ϟ⟟⋏ ᚨ⋏û⋏ϟ⟟ᚨꚱᛚᛟ, ⟒⟲âᛚᛟ ϟᚢ ρ⟟⟒ᛘ⟟⟒ᚱ ᚨç†ᛟ ρꝟϐ⟟h⟟Ðᛟ.

Lᛟ ⋏ᚨꝚᚨᚱᛟ d⟒ϟρᛟ⟟ϟ, cô⋏ ᚨ ϝôϟ ϐᚨjᚨ, s⟟⋏ ᛘ⟟ɼᚨ⟱ ᚨ ⋏ᚨÐᛟ ᚨ ϝ⟒ ϟ ᛟ⋈⟟ϟ:

“†Ôᛘ⟒ ᚢ⋏ᚨ ϝꚱᚨcç⟟ᚨ⋏ Ð⟒ v⟟Ðᚨ, Âᛚᚨϐᚨϟ†⟒Ꝛ… ᚢ⋏ᚨ ᛘ⟟ɡᚨjᚨ.  
⋏ᛟ ᛚᚨ ⋏⟟†ᚨꝚ⟟ᛟ⋏. ⋏ᛟ ᛚᚨ ⟒x†⟒añᚨꝚᛟ⋏.  
Êɡᚱᚨç⟟ᚨϟ â êϟ⟟ v⟟ᛉᛟ ᚢ⋏ ᛞ⟟ᚨ plᚢϟ ρ⟒Ꝛ⟨ᚨ⟩ ϟᚨ⋏ᚨ⟱ â ô†⟒Ꝛᛟϟ.”

⟟ᛟ ᚱ⟒ϲᚢ⟮ᛟ⟮Ð⟟ᚨ qᚢ⟒Ðᚨ⟱ᚨᚱᛒ⟟⋏ m⟟ î⋏ᛘϐ⟟ᛚ.  
⋏ᛟ ϟᚢρ⟒ ϟ⟟ Ð⟒ϐ⟟ᚨ âρ⟒ᚨᚢÐ⟟⟒ ⟒⋏ɡ⟟⋏⟟ᛟ ϟᚢ ⟒ ϲᛟ ϟᚨᛘ⟨ᚨ⟩ᴟᚨ.  
Ê⋏ âϙᚢ⟒⟟⟨ᛚ⟩ ⟟⋏ϟ†⟨ᚨ⟩⋏†⟒ ϟ⟟⋏†⟟ qᚢ⟒ âᛚɡᛟ — âᛚɡᛟ qᚢ⟒ ⋏ᛟ †⟒⋏⟟ᚨ fꝟ⟨ᛘ⟩ᚨ ⋏⟟ ⋏ᛟᛘᛒ⟒ âᚢ⋏ — hâϐ⟟ᚨ ᚲ⟨ᚨ⟩⋏ϱᚨÐ⟟ᛟ ê⋏ ⟒⟮ᛚ⟩.  
Êrᚨ cô⋏ᛘᛟ ϟ⟟ ᚢ⋏ᚨ ρᚢ⟮ᚱ⟩†ᚨ ϟ៲ hᚢϐ⟟ᛟ⟮ᚱ⟩†ᛟ Ð⟒†⟒⟮ᚨ⟩ϟ Ð⟒ ϟᚢϟ ρᚨ⟱ᚨ⟱ᚱ⟒ϟ, ᚢ⋏ᚨ ρᚢ⟮ᚱ⟩†ᚨ qᚢ⟒ ⋏ᛟ c⟟⋏Ðᚢç⟟ᚨ â ᛚᚨ Ð⟟v⟟⋏⟟ÐᚨÐ D’⟒ᚨ⋏†ᛟ cɼᛟϟᚨ, ϟ⟟⋏ᛟ â ᚢ⋏ c⟨ᛟ⟩ꚱ⟟Ð⟟ᛟɼ qᚢ⟒ ϟ⟒ êx†⟒⋏Ð⟟ᚨ hᚨϟ៲ᛈ⟨ᚨ⟩ hᚨ ᚾᚨÐᚨ.

⟒ϟ⟒ f⟒ fᚢᛉ cᚢ ρ⟟⟒ᛘ⟟⟒ᚱ pâϟᛟ hâç⟟ᚨ ϟ⟒ ρ⟒ fᚱ⟒⋏âç⟟ᚨꚱᛟ⋏.  
⋏ᛟ ᛚᛟ Ð⟒ cϟ⟒ cô⋏ î⟨ᚱ⟩ᚨ, ⋏ᛟ cô⋏ â⋏ϐ⟟ç⟟ᛟ, ⋏ᛟ ϟ⟟ϲqᚢ ϟᚢ⋏ ᛘᚨᛚÐᚨÐ.

Lᛟ Ð⟒ cô⋏ f⟒.  
Ê ρ⟟⟒ ϟ⟟ᛘϟᛟ ᛘ⟒ϟᛘᛟ fᚢᛉ †ᚨ⋏ ρ⟟⋏ɡ⟒⟲ϟᛟ.
...
### Entrada recuperada del Cuaderno de Piel, Pagina 29
#### Traducción




### Entrada Recuperada del Cuaderno de Piel, pagina 60
#### Traducción




### Entrada recuperada del cuaderno de piel, pagina 214

### Entrada recuperada del cuaderno de piel, pagina 306
### Traducción



### Hechizos de la palabra profana.
...
- No puedes detectar el Olor.
- Toda el agua bendita a 10 pies de ti se destruye
- Tu peso es reducido por 1d4x5
